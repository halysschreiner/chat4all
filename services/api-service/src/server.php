...
try {
    ...
    $redis = new RedisService($redisHost, $redisPort, $logger);
    $notificationService = new NotificationService($redis, $logger);
    $jwtSecret = getenv('JWT_SECRET') ?: 'default-secret';

    $service = new MessageService($db, $kafka, $notificationService, $logger);

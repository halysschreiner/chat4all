...
/**
 * Consumidor Kafka para o Connector Instagram Mock
 * 
 * Este componente implementa o padrão Consumer do Apache Kafka, responsável por:
 * - Consumir mensagens do tópico 'instagram.messages'
 * - Processar mensagens e simular entrega ao Instagram
 * - Enviar callbacks de status (DELIVERED, READ) de volta à API
 * 
 * CONCEITO DE SISTEMAS DISTRIBUÍDOS:
 * O Consumer Group (instagram-connector-group) permite escalabilidade horizontal.
...
class KafkaConsumer
{
     ...
     * 2. Process: processa a mensagem (simula entrega ao Instagram)
